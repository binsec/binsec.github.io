...
## Motivation
**Timing channels** are software vunelrabilities happenning when timing variations in a program depend
...
The function iterates through each character of the input string and returns
