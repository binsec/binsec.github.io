...
access to the value of `secretarray` (even if we consider that they
can observe the state of the cache and recover the value of `toLeak`).
...
- \[4\] [Daniel, L., Bardin, S., Rezk, T., *Binsec/Rel: Efficient
  ...
  SP'20](https://arxiv.org/abs/1912.08788)
